...
* @{
*/
#define PRODUCT_KEY "76e9e3383a744ba193b60c5db0b0b1"
/**@} */
/**@name Product Secret  
* @{
*/
#define PRODUCT_SECRET "0d43304f7b844489ee66c84d9976dc5"
...
*/
#define fan_LEN                           1
#define water_pump_LEN                           1
#define ventilation_opening_LEN                           1
#define LED_LEN                           1
#define buzzer_LEN                           1
#define Model_LEN                           1
...
#define soil_temperature_RATIO                         1
#define soil_temperature_ADDITION                      0
#define soil_temperature_MIN                           0
#define soil_temperature_MAX                           99
#define soil_temperature_LEN                           1
#define soil_humidity_RATIO                         1
#define soil_humidity_ADDITION                      0
#define soil_humidity_MIN                           0
#define soil_humidity_MAX                           99
#define soil_humidity_LEN                           1
#define LUX_RATIO                         1
...
typedef struct {
    bool valuefan;
    bool valuewater_pump;
    bool valueventilation_opening;
    bool valueLED;
    bool valuebuzzer;
    uint32_t valueModel;
    uint32_t valueTemperature;
    uint32_t valueHumidity;
    uint32_t valuesoil_temperature;
    uint32_t valuesoil_humidity;
    uint32_t valueLUX;
    uint32_t valueCO2;
} dataPoint_t;
...
typedef struct {
    uint8_t flagfan:1;
    uint8_t flagwater_pump:1;
    uint8_t flagventilation_opening:1;
    uint8_t flagLED:1;
    uint8_t flagbuzzer:1;
    uint8_t flagModel:1;
    uint8_t flagTemperature:1;
    uint8_t flagHumidity:1;
    uint8_t flagsoil_temperature:1;
    uint8_t flagsoil_humidity:1;
    uint8_t flagLUX:1;
    uint8_t flagCO2:1;
} dataPointFlags_t;
...
typedef struct {
    ...
    uint8_t valuesoil_temperature;
    uint8_t valuesoil_humidity;
    uint16_t valueLUX;
    uint16_t valueCO2;
} devStatus_t;
