...
void userHandle(void)
{
    ...
    currentDataPoint.valuesoil_temperature = sensorData.soilTemp;//Add Sensor Data Collection
    currentDataPoint.valuesoil_humidity = sensorData.soilHumi;//Add Sensor Data Collection
...
void userInit(void)
{
    ...
    currentDataPoint.valuesoil_temperature = ;
    currentDataPoint.valuesoil_humidity = ;
